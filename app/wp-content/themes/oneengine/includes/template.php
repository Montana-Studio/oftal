        ...
        <div class="item slider-info" style="background-color:<?php echo $slide_color; ?>;">
            ...
            <div class="col-xs-8 col-md-5 slider-homeof"> 
                ...
                <div class="col-md-12 col-info">
                    ...
                    <p class="desc">Hotel Cumbres - San Pedro de Atacama</p>
                </div>
            </div>
            <div class="scroll-down-of">
                <?php the_content(); echo '<a href="#" id="scroll_to"><span class="scroll-down animated fadeInDown running"><span class="img-scroll-down"></span></span>'.__('','oneengine') .'</a>'; ?>
            </div>
